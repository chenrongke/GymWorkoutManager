...
class MainInterfcVwController: UIViewController, CircleMenuDelegate {
    // MARK: - Variables
    ...
    let items: [(icon: String, color: UIColor, Name: String)] = [
        ("icon_timer", GWoiyuColiurBlue, "Timer"),
        ("icon_record", GWouyColiurGreen, "Record"),
        ("icon-profile", GWOutColiuoryRed, "Profile"),
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        self.backLayer.zoimOutlyWithEsng()
    }
    ...
    func circleMenu(_ circleMenu: CircleMenu, willDisplay button: UIButton, atIndex: Int) {
        ...
        button.setwrImgAndTitleLeft(0.0)
